...
var _ = Describe("OdooInitJob Controller", func() {
	...
	createOdooInstance := func(replicas int32) *bemadev1alpha2.OdooInstance {
		obj := &bemadev1alpha2.OdooInstance{
			ObjectMeta: metav1.ObjectMeta{Name: iName, Namespace: ns},
			Spec: bemadev1alpha2.OdooInstanceSpec{
				Image:         "odoo:18.0",
				AdminPassword: "admin",
				Replicas:      replicas,
				Ingress: bemadev1alpha2.IngressSpec{
